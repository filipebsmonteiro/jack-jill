<template>
  <section class="relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl lg:max-w-4xl">
      <p class="text-center order-first text-3xl font-semibold tracking-tight text-secondary sm:text-5xl">Name Location</p>
      <figure class="mt-10">
        ...
        <figcaption class="mt-10">
          ...
          <div class="mt-4 flex items-center justify-center space-x-3 text-base">
            ...
            <div class="text-secondary">CEO of Workcation</div>
          </div>
        </figcaption>
      </figure>
    </div>
